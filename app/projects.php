    ...
    <div class="page">
      ...
      <div id="benteichman">
        <div class="container section jumbo">
          <img class="project-icon" src="img/webicon.png">
      ...
      <div id="unify">
        <div class="container section jumbo">
          <hr>
          <img class="project-icon" src="img/unify.png">
          <h2>Unify</h2>
      ...
      <div id="charmaster">
        <div class="container section jumbo">
          <hr>
          <img class="project-icon" src="img/charmaster.png">
      ...
      <div id="oncampus">
        <div class="container section jumbo">
          <hr>
          <img class="project-icon" src="img/oncampus.png">
          <h2>OnCampus</h2>
